...
const SHAPES_BY_LEVEL = [
  // Nível 1-2: formas básicas e fillers (1-3 blocos)
  [
    [[0, 0]],                                 // Ponto (1x1)
    [[0, 0], [0, 1]],                         // Dupla H (1x2)
    [[0, 0], [1, 0]],                         // Dupla V (2x1)
    ...
    [[0, 1], [1, 0], [1, 1]],                 // Mini J
    [[0, 0], [0, 1], [0, 2]],                 // Linha 3
    [[0, 0], [1, 0], [2, 0]],                 // Coluna 3
    [[0, 0], [1, 1]],                         // Diagonal 2
  ],
  // Nível 3-5: formas médias (4 blocos) - Geometria de preenchimento
  [
    [[0, 0], [0, 1], [1, 0], [1, 1]],         // Quadrado 2x2
    [[0, 0], [0, 1], [0, 2], [0, 3]],         // Linha 4
    [[0, 0], [1, 0], [2, 0], [3, 0]],         // Coluna 4
    [[0, 0], [0, 1], [0, 2], [1, 1]],         // T
    [[0, 0], [1, 0], [2, 0], [2, 1]],         // L
    [[0, 1], [1, 1], [2, 0], [2, 1]],         // J
    [[0, 0], [1, 0], [1, 1], [2, 1]],         // S
    [[0, 1], [1, 0], [1, 1], [2, 0]],         // Z
    [[0, 0], [0, 1], [1, 0], [2, 0]],         // L Invertido
    [[0, 0], [0, 2], [1, 0], [1, 2]],         // Dupla Dupla (paralelo)
  ],
  // Nível 6+: Mega Formas e Ocos
  [
    [[0, 0], [0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]], // Mega Quadrado 3x3 (Raro)
    [[0, 0], [0, 1], [0, 2], [1, 0], [1, 2], [2, 0], [2, 1], [2, 2]],         // Quadrado Oco (O)
    [[0, 0], [0, 1], [0, 2], [1, 2], [2, 2]], // L Gigante
    [[0, 2], [1, 2], [2, 0], [2, 1], [2, 2]], // J Gigante
    [[0, 1], [1, 0], [1, 1], [1, 2], [2, 1]], // Plus +
    [[0, 0], [0, 1], [1, 1], [2, 1], [2, 2]], // Escada 5
    [[0, 0], [0, 2], [1, 1], [2, 0], [2, 2]], // X (Cruz diagonal)
    [[0, 0], [0, 1], [0, 2], [1, 0], [1, 2]], // Copo U
    [[0, 0], [0, 1], [0, 2], [0, 3], [0, 4]], // Linha 5
    [[0, 0], [1, 0], [2, 0], [3, 0], [4, 0]], // Coluna 5
  ],
];
